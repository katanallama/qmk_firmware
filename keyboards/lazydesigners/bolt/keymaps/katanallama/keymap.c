...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
               ...
               MO(3),    KC_LALT,                   KC_LGUI, LT1_SPC,     LT2_SPC, KC_LGUI,                   KC_RALT,  KC_DOWN, KC_RGHT
             ),
    [1] = LAYOUT(
               KC_GRV,   KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                 KC_6,    KC_7,    KC_8,    KC_9,     KC_0,    KC_DEL,
               G(KC_5),  G(KC_4), G(KC_3), G(KC_2), G(KC_1), G(KC_GRV),            KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, KC_LBRC, KC_RBRC,
    ...
    [2] = LAYOUT(
               ...
               KC_NO,    KC_NO,   KC_NO,   SCRECG,  KC_PSCR, SCREC,                KC_NO,   KC_EQL,  KC_MINS, KC_LBRC,  KC_QUOT, KC_BSLS,
               KC_NO,    KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,       KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,    KC_NO,   KC_NO,
               KC_VOLD,  KC_MUTE,                   KC_VOLU, KC_TRNS,     KC_TRNS, KC_NO,                     KC_NO,    KC_NO,   KC_NO
             ),
    [3] = LAYOUT(
               QK_BOOT,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                KC_NO,   KC_7,    KC_8,    KC_9,     KC_NO,   KC_NO,
               KC_NO,    KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                KC_NO,   KC_4,    KC_5,    KC_6,     KC_NO,   KC_NO,
               KC_NO,    KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,       KC_NO,   KC_NO,   KC_1,    KC_2,    KC_3,     KC_NO,   KC_NO,
               KC_NO,    KC_NO,                     KC_NO,   KC_NO,       KC_NO,                     KC_0,    KC_NO,    KC_NO,   KC_NO
             ),
};
